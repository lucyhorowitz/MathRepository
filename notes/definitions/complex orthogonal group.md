The **complex orthogonal group** $\text{O}(n,\mathbb C)$ is the set of $n\times n$ complex [[matrix|matrices]] whose [[matrix transpose|transposes]] are equal to their [[inverse matrix|inverses]]. 
